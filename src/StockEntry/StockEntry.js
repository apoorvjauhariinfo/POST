            ...
            try {
                ...
                if(exist == 0){
                    const loadUsers = async () => {
                        const response = await Axios.post(process.env.REACT_APP_BASE_URL+"api/poststocks", stock);
                    ...
                    const loadUsers = async () => {
                        try {
                            const res = await axios.put(process.env.REACT_APP_BASE_URL+'api/updateexistingstocks/' + currst.toString(), {
                                _id: currst.toString(),
                                // productid: id,
                                 batchno: values.batchno,
                                 unitcost: values.unitcost,
